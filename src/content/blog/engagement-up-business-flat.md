...
tags: ["互动率", "增长指标", "内容数据"]
---
> **TL;DR** —— 互动率上涨，只能说明更多人做了点赞、评论或分享，不能自动证明品牌吸引了正确的人。抽奖、争议和轻量问题都能制造热闹，业务增长却需要用户继续进入主页、提出有效问题、留下线索或形成购买意向。指标必须与内容任务连接。
...
> 互动率告诉你有人动了手指，增长要回答的是他为什么愿意继续往前走。
...
- 发布前写清目标用户和 7 天内希望发生的动作。
- 按认知、教育、信任和转化设置不同指标。
- 每周抽样阅读 50 条评论和私信，判断人群质量。
- 同时看互动、主页访问、咨询和 30 天后续行为。
